...
import com.kernotec.farm.activity.rest.mapper.group.GroupToMembershipResponseMapper;
...
@Mapper(uses = {GroupToMembershipResponseMapper.class, ActivityResponseFlatMapper.class,
