    ...
    AbstractTransactionalRequiredCommand<ProcessActivityCreateRequestCmd.Request, UUID>
{
    ...
    private final ActivityCreateRequestValidateCmd activityCreateRequestValidateCmd;

    @Override
    protected void validate(Request request) {
        activityCreateRequestValidateCmd.withRequest(
                ActivityCreateRequestValidateCmd.Request.builder()
