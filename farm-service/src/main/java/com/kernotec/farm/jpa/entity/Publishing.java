...
public class Publishing extends BaseAuditEntity {
  ...
  @JoinColumn(name = "publishing_type_id", referencedColumnName = "id", insertable = false, updatable = false)
  ...
  @ManyToOne(optional = false, fetch = FetchType.LAZY)
  @JoinColumn(name = "publishing_context_id", referencedColumnName = "id", insertable = false, updatable = false)
